...
S {}
E {}
B 2 -720 -950 80 -550 {flags=graph
y1=-1.3e-05
y2=1.3e-05
ypos1=0
ypos2=2
...
logy=0
hilight_wave=-1}
B 2 620 -940 1420 -540 {flags=graph
...
divy=10
y1=-0.027}
B 2 620 -520 1420 -120 {flags=graph
y1=-0.00042
y2=0.00042
ypos1=0
ypos2=2
...
color=7
node=vout1}
B 2 620 -100 1420 300 {flags=graph
y1=-0.00043
y2=0.00043
ypos1=0
ypos2=2
...
C {devices/vsource.sym} -700 -250 0 0 {name=V1 value=1.8
}
C {devices/vsource.sym} -620 -230 0 0 {name=V2 value=-1.8}
C {devices/vsource.sym} -510 -210 0 0 {name=V3 value="SIN(0 12.1u 50K 0 0 0)" }
C {devices/vsource.sym} -340 -190 0 0 {name=V4 value="SIN(0 12.1u 50K 0 0 180)" }
C {devices/gnd.sym} -700 -200 0 0 {name=l1 lab=GND}
...
C {devices/code_shown.sym} 0 -475 0 0 {name=s2 only_toplevel=false value=".control
save all
tran 1u 200u
write IA_v2_testbench.raw
.endc"}
C {devices/lab_wire.sym} -510 -250 0 0 {name=p4 sig_type=std_logic lab=IN1}
...
C {devices/code.sym} -170 -460 0 0 {name=TT_MODELS
only_toplevel=true
...
"
spice_ignore=false}
C {devices/launcher.sym} 440 -440 0 0 {name=h5
descr="load waves" 
