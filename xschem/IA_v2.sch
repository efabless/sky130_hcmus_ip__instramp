...
C {devices/ipin.sym} -260 0 1 1 {name=p28 lab=D9
}
C {devices/ipin.sym} -240 0 1 1 {name=p29 lab=D8
}
C {devices/ipin.sym} -220 0 1 1 {name=p30 lab=D7
}
C {devices/ipin.sym} -200 0 1 1 {name=p31 lab=D6
}
C {devices/ipin.sym} -180 0 1 1 {name=p32 lab=D5
}
C {devices/lab_wire.sym} -260 -1020 3 1 {name=p33 lab=D9
}
C {devices/lab_wire.sym} -240 -1020 3 1 {name=p34 lab=D8
}
C {devices/lab_wire.sym} -220 -1020 3 1 {name=p35 lab=D7
}
C {devices/lab_wire.sym} -200 -1020 3 1 {name=p36 lab=D6
}
...
spiceprefix=X
mult=64}
C {/home/caonam/OpenLane/FINALPROJECT/sky130_hcmus_ip__instramp/xschem/opamp.sym} -810 -960 0 0 {name=x8}
C {/home/caonam/OpenLane/FINALPROJECT/sky130_hcmus_ip__instramp/xschem/opamp.sym} -810 -100 0 0 {name=x9}
