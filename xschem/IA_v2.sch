...
lab=D9}
N -1140 -680 -1140 -660 {}
C {sky130_fd_pr/res_xhigh_po.sym} -930 -940 1 0 {name=R11
W=2
L=1
model=res_xhigh_po
spiceprefix=X
mult=1}
C {sky130_fd_pr/res_xhigh_po.sym} -930 -80 3 0 {name=R15
W=2
L=1
model=res_xhigh_po
spiceprefix=X
mult=1}
C {sky130_fd_pr/res_xhigh_po.sym} -1140 -530 2 0 {name=R20
W=2
L=1
model=res_xhigh_po
spiceprefix=X
