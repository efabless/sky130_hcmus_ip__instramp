...
C {/foss/pdks/gf180mcuC/libs.tech/xschem/symbols/ppolyf_u.sym} -520 -170 0 0 {name=R1
W=1e-6
L=50e-6
model=ppolyf_u
spiceprefix=X
m=1}
C {/foss/pdks/gf180mcuC/libs.tech/xschem/symbols/ppolyf_u.sym} -520 0 0 0 {name=R2
W=1e-6
L=50e-6
model=ppolyf_u
spiceprefix=X
m=1}
C {/foss/pdks/gf180mcuC/libs.tech/xschem/symbols/ppolyf_u.sym} -520 170 0 0 {name=R3
W=1e-6
L=50e-6
model=ppolyf_u
spiceprefix=X
...
C {/foss/pdks/gf180mcuC/libs.tech/xschem/symbols/cap_mim_2p0fF.sym} -10 -60 1 0 {name=C1
W=5.55e-6
L=10e-6
model=cap_mim_2f0fF
spiceprefix=X
m=1}
C {/foss/pdks/gf180mcuC/libs.tech/xschem/symbols/ppolyf_u.sym} 70 -60 1 0 {name=R4
W=1e-6
L=7e-6
model=ppolyf_u
spiceprefix=X
m=1}
C {devices/opin.sym} 160 70 0 0 {name=p5 lab=VOUT}
